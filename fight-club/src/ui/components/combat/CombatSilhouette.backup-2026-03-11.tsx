...
export function CombatSilhouette({
  ...
  return (
    <div style={{ display: "grid", gap: "10px", justifyItems: "center", width: "220px", margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", gap: "12px", flexWrap: "wrap", justifyContent: "center", fontSize: "12px", opacity: 0.82 }}>
...
function EquipmentSlotButton({
  ...
  return (
    ...
    >
      ...
      <div style={{ marginTop: "2px", fontSize: "6px", textTransform: "uppercase", opacity: 0.68 }}>
        {formatEquipmentSlotLabel(slot)}
      </div>
      <div style={{ marginTop: "1px", fontSize: "7px", fontWeight: 700, lineHeight: 1.05 }}>
