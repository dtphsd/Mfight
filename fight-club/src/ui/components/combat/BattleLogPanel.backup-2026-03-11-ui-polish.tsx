    ...
    <div data-testid="battle-log-panel" style={{ display: "grid", gap: "8px" }}>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "8px", flexWrap: "wrap" }}>
          <div style={{ fontSize: "11px", fontWeight: 700, color: "#fff7ee", textTransform: "uppercase", opacity: 0.78 }}>Combat Log</div>
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: `0 10px 22px ${entryTheme.shadow}`,
        display: "grid",
        gap: "6px",
      }}
    >
      ...
      <div style={{ fontSize: "12px", lineHeight: 1.4, color: "#fff7ee" }}>{entry.message}</div>

      <div style={{ display: "flex", gap: "6px", flexWrap: "wrap" }}>
        {entry.defenderName ? <MetaPill label="Target" value={entry.defenderName} /> : null}
        {entry.attackZone ? <MetaPill label="Zone" value={formatMaybeTitle(entry.attackZone)} /> : null}
        {entry.damageType ? <MetaPill label="Type" value={formatMaybeTitle(entry.damageType)} /> : null}
        {entry.damage !== null ? (
