...
import type { BuilderPopoverProps, ZoneOutlook } from "./builderPopoverTypes";
...
function BuilderLoadoutPanel({ metrics }: Pick<BuilderPopoverProps, "metrics">) {
  return (
    <PanelCard compact>
      <SectionIntro
        label="Loadout"
...
function BuilderDefenseAndModifiersPanel({ metrics }: Pick<BuilderPopoverProps, "metrics">) {
  return (
    <>
...
function BuilderMatchupPanel({ metrics }: Pick<BuilderPopoverProps, "metrics">) {
  return (
    <>
      <PanelCard compact>
        <SectionIntro
